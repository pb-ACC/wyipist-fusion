...
function getPalets(data){    
    tablePaletes= new Tabulator("#selected-palets-table", {
        ...
        columns:[
            ...
            {title:"QTD.", field:"Quantidade", align:"center",headerFilter:"input",bottomCalc:"sum", bottomCalcParams:{precision:3}},
...
function listExtrato(data){
    ...
    tableExtrato= new Tabulator("#extrato-palete-table", {
        ...
        columns:[
            ...
            {title:"QTD.", field:"Quantidade", align:"center",headerFilter:"input",bottomCalc:"sum", bottomCalcParams:{precision:3},formatter:typeMOV},
            {title:"Acumulado", field:"Acumulado", align:"center",headerFilter:"input",bottomCalc:"sum", bottomCalcParams:{precision:3},formatter:typeMOV},
