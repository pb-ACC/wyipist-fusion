...
$("#list-stk01").addClass("active");
$("#list-stk02").addClass("active");
...
function choose_palets(){    
    ...
    $.ajax({
        type: "POST",
        url: "http://127.0.0.1/wyipist-fusion/standards/ListarFiltro/filtraPlZn_emanuel_corrige_stk_positivo/"+emp+"/"+newSector,
        dataType: "json",
        success: function (data) {
            if (data === "kick") {
                toastr["warning"]("Outro utilizador entrou com as suas credenciais, faça login de novo.");
