<div class="content-wrapper">
    ...
    <section class="content-header">        
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Anulação Preparação de Cargas</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fa-solid fa-times-circle"></i> Anulação Preparação de Cargas</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script src="<?=base_url();?>js/planos_carga/anulacao/anulacao_carga.js"></script>