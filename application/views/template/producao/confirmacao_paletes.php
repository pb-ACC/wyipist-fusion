<div class="content-wrapper">
    ...
    <section class="content-header">        
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Confirmação Paletes</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fas fa-check-circle"></i> Confirmação Paletes</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script src="<?=base_url();?>js/producao/confirmacao_paletes.js"></script>