<div class="content-wrapper">
    ...
    <section class="content-header">        
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Correção de Stock (Negativo)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><i class="fa-solid fa-edit"></i> Correção de Stock</li>
                        <li class="breadcrumb-item active"><i class="fa-solid fa-minus-circle"></i> Negativo</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script src="<?=base_url();?>js/stocks/corrigir_stock/negativo/corrigir_stock.js"></script>