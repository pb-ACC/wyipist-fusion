            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fas fa-ban"></i> Anulação Preparação de Carga</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>    
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/prep_carga/anulacao/AnulacaoPreparacaoCarga/listGG",
            dataType: "json",
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/prep_carga/anulacao/AnulacaoPreparacaoCarga/radioButton",
            dataType: "json",
    ...
    function listGG(data){
        ...
        tableGG= new Tabulator("#gg-table", {
            ...
            rowClick:function(e, row){
                window.location.href = "<?=base_url();?>stocks/anulacao_preparacao_carga/"+row.getData().Numero;
            },
            selectable:true,
    ...
    function changeSector(newSector){
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/prep_carga/anulacao/AnulacaoPreparacaoCarga/listGG_changeOP/"+newSector,
            dataType: "json",
            success: function (data) {
                //alert(data);
               // console.log(data);
