<div class="content-wrapper">
    ...
    <section class="content-header">        
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Paletes Sem Stock</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>home"> Home</a></li>
                        <li class="breadcrumb-item"><i class="nav-icon fas fa-industry"></i> Stocks</li>                        
                        <li class="breadcrumb-item active"><i class="fas fa-pallet"></i> Paletes Sem Stock</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card card-info">
                ...
                <div class="card-footer" style="display: block;">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-sm-push-3 col-xs-12 col-md-4 col-md-push-4 col-lg-4 col-lg-push-4" >
                            <button id="confirma_sem_stock" onclick="confirma_sem_stock()" type="button" class="btn btn-info" style="width:inherit;margin-left: 5px;margin-right: 5px;margin-bottom: 5px;"> Confirmar</button>
                        </div>
                    </div>	
                </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/PaleteSemStock/listPalets",
            dataType: "json",
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/PaleteSemStock/radioButton",
            dataType: "json",
    ...
    function changeSector(newSector){
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/PaleteSemStock/listPalets_changeOP/"+newSector,
            dataType: "json",
            success: function (data) {
                //alert(data);
               // console.log(data);
    ...
    function confirm_palete_sem_stock(){
        ...
        $("#confirma_sem_stock").prop("disabled",true);
        
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/PaleteSemStock/guarda_palete_sem_stock",
            dataType: "json",
            data:{
            ...
            error: function (e) {
                    //alert(e);
                    $("#confirma_sem_stock").prop("disabled",false);
                    alert('Request Status: ' + e.status + ' Status Text: ' + e.statusText + ' ' + e.responseText);
                    console.log(e);
            }
        });          
