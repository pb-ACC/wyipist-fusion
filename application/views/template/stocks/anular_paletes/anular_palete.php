<div class="content-wrapper">
    ...
    <section class="content-header">        
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Anular Paletes PLP</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fas fa-history"></i> Anular Paletes PLP</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/anular_paletes/AnularPalete/listPalets",
            dataType: "json",
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/anular_paletes/AnularPalete/radioButton",
            dataType: "json",
    ...
    function changeSector(newSector){
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/anular_paletes/AnularPalete/listPalets_changeOP/"+newSector,
            dataType: "json",
            success: function (data) {
                //alert(data);
               // console.log(data);
    ...
    function save_anulacao(){    
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/anular_paletes/AnularPalete/guarda_anulacao_palete",
            dataType: "json",
            data:{
