<div class="content-wrapper">
    ...
    <section class="content-header">        
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Caixas Partidas</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>home"> Home</a></li>
                        <li class="breadcrumb-item"><i class="nav-icon fas fa-industry"></i> Stocks</li>                        
                        <li class="breadcrumb-item active"><i class="fas fa-house-damage"></i> Caixas Partidas</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card card-info">
                ...
                <div class="card-footer" style="display: block;">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-sm-push-3 col-xs-12 col-md-4 col-md-push-4 col-lg-4 col-lg-push-4" >
                            <button onclick="confirma_partidas()" type="button" class="btn btn-info" style="width:inherit;margin-left: 5px;margin-right: 5px;margin-bottom: 5px;"> Confirmar</button>
                        </div>
                    </div>	
                </div>
...
<div id="qtd-caixas-partidas" class="modal fade bd-example-modal-lg" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title">Indique o número de caixas partida</h5>
				<button id="btnclose" type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 col-sm-push-12 col-xs-12 col-md-12 col-md-push-12 col-lg-12 col-lg-push-12" >                                               
			...
			<div class="modal-footer">		  
            <button id="guarda_caixas_partidas" type="button" class="btn btn-success" onclick="guarda_caixas_partidas()"><i class="fas fa-save"></i> Confirmar</button>	                          
			</div>    
    </div>
  </div>
</div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/CaixasPartidas/listPalets",
            dataType: "json",
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/CaixasPartidas/radioButton",
            dataType: "json",
    ...
    function changeSector(newSector){
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/CaixasPartidas/listPalets_changeOP/"+newSector,
            dataType: "json",
            success: function (data) {
                //alert(data);
               // console.log(data);
    ...
    function listPalets(data){
        ...
        tablePaletes= new Tabulator("#palets-table", {
            ...
            columns:[
                ...
                {title:"CaixasPorPalete", field:"CaixasPorPalete", align:"center", visible:false},
                {title:"QtdCx", field:"QtdCx", align:"center", visible:false}
            ]
        });
    ...
    function confirma_partidas(){        
        sizeofTBL=tableSelPaletes.getData();        
        if(sizeofTBL.length>0){
            
            if(parseFloat(tableSelPaletes.getData()[0]['CaixasPorPalete']) > 0){
                type='success';
                ...
                toastr["error"]("Os M2 por caixa da referência "+tableSelPaletes.getData()[0]['Referencia']+" não estão parametizados."+"<br>"+"Contacte o responsável.");
                tableSelPaletes.destroy();
                data=[];
                selectedPalets(data);
    ...
    function confirm_confirma_partidas(){
        ...
        setTimeout(function () {  
            $("#qtd-caixas-partidas").modal("show");
        }, 350);
    ...
    function guarda_caixas_partidas(){        
        
        if(parseFloat($("#qtd").val()) > 0){

            if(parseFloat($("#qtd").val()) <= parseFloat(tableSelPaletes.getData()[0]['CaixasPorPalete'])){

                $("#guarda_caixas_partidas").prop("disabled",true);                 

                $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>stocks/CaixasPartidas/guarda_caixas_partidas",
                dataType: "json",
                data:{
                ...
                error: function (e) {
                    //alert(e);
                    $("#guarda_caixas_partidas").prop("disabled",false); 
                    alert('Request Status: ' + e.status + ' Status Text: ' + e.statusText + ' ' + e.responseText);
                    console.log(e);
                }
                ...
                val = (parseFloat(tableSelPaletes.getData()[0]['Quantidade']) - parseFloat($("#qtd").val())) * -1 ;
                toastr["error"]("Quantidade inserida supera em "+ val +" M2 da palete!");
            }
