        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fas fa-truck-loading"></i> Troca Localização</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card card-info">
                ...
                <div class="card-footer" style="display: block;">
                    ...
                    <div id="factory" class="col-sm-12 col-sm-push-3 col-xs-12 col-md-4 col-md-push-4 col-lg-4 col-lg-push-4" >
                        <button onclick="change_position()" type="button" class="btn btn-dark" style="width:inherit;margin-left: 5px;margin-right: 5px;margin-bottom: 5px;"> Mudar Localização</button>
                    </div>
                </div>	
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/mov_interna/MovInterna_troca_localizacao/listPalets",
            dataType: "json",
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/mov_interna/MovInterna_troca_localizacao/radioButton",
            dataType: "json",
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/mov_interna/MovInterna_troca_localizacao/localizacaoCB",
            dataType: "json",
    ...
    function changeSector(newSector){
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/mov_interna/MovInterna_troca_localizacao/listPalets_changeOP/"+newSector,
            dataType: "json",
            success: function (data) {
                //alert(data);
               // console.log(data);
        ...
        setTimeout(function () {       
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>stocks/mov_interna/MovInterna_troca_localizacao/localizacaoCB_changeOP/"+newSector,
                dataType: "json",
    ...
    function selectedPalets(data){
        tableSelPaletes= new Tabulator("#selected-palets-table", {
            ...
            columns:[                
                ...
                {title:"Operador", field:"Operador", align:"center", visible:false},
                {title:"Sel", field:"Sel", align:"center", visible:false},
                {title:"Local Atual", field:"Local", align:"center"},
    ...
    function confirm_change_position(){
        ...
        $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>stocks/mov_interna/MovInterna_troca_localizacao/save_new_position",
                dataType: "json",
                data:{
                    tbl: tableSelPaletes.getData(),
                    local : tableLocal.getSelectedData()[0]['CodigoBarras'],
                    novoSector : tableLocal.getSelectedData()[0]['Codigo']
                },
                success: function (data) {
                    //alert(data);
                    //console.log(data);
