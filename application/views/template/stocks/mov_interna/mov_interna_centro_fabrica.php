<div class="content-wrapper">
    ...
    <section class="content-header">        
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Mov. Internas (Centro->Fábrica)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fas fa-truck-moving"></i> Centro->Fábrica</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card-footer" style="display: block;">
                    <div class="row">
                        ...
                        <div id="factory" class="col-sm-12 col-sm-push-3 col-xs-12 col-md-4 col-md-push-4 col-lg-4 col-lg-push-4" >
                            <button id="send_to_factory" onclick="send_to_factory()" type="button" class="btn btn-info" style="width:inherit;margin-left: 5px;margin-right: 5px;margin-bottom: 5px;"> Enviar Armazém Fábrica</button>
                        </div>
                    </div>	
                </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/mov_interna/MovInterna_centro_fabrica/listPalets",
            dataType: "json",
    ...
    function confirm_send_to_factory(){
      
        $("#send_to_factory").prop("disabled",true);

          $.ajax({
              type: "POST",
              url: "<?php echo base_url();?>stocks/mov_interna/MovInterna_centro_fabrica/save_movement_factory",
              dataType: "json",
              data:{
              ...
              error: function (e) {
                  //alert(e);
                  $("#send_to_factory").prop("disabled",false);
                  alert('Request Status: ' + e.status + ' Status Text: ' + e.statusText + ' ' + e.responseText);
                  console.log(e);
              }
