<div class="content-wrapper">
    ...
    <section class="content-header">        
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Não Conformidade</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>home"> Home</a></li>
                        <li class="breadcrumb-item"><i class="nav-icon fas fa-industry"></i> Stocks</li>                        
                        <li class="breadcrumb-item active"><i class="fas fa-times"></i> Não Conformidade</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card-footer" style="display: block;">
                    <div class="row">
                        ...
                        <div id="factory" class="col-sm-12 col-sm-push-3 col-xs-12 col-md-4 col-md-push-4 col-lg-4 col-lg-push-4" >
                            <button onclick="fabrica_to_pnc()" type="button" class="btn btn-info" style="width:inherit;margin-left: 5px;margin-right: 5px;margin-bottom: 5px;"> Enviar para PNC Fábrica</button>
                        </div>
                        <div id="move_logistics" class="col-sm-12 col-sm-push-3 col-xs-12 col-md-4 col-md-push-4 col-lg-4 col-lg-push-4" style="display:none;">
                            <button onclick="cl_to_pnc_fabrica()" type="button" class="btn btn-info" style="width:inherit;margin-left: 5px;margin-right: 5px;margin-bottom: 5px;"> Enviar para PNC Centro Logístico </button>
                        </div>
                    </div>	
                </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/NaoConforme/listPalets",
            dataType: "json",
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/NaoConforme/radioButton",
            dataType: "json",
    ...
    function changeSector(newSector){
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>stocks/NaoConforme/listPalets_changeOP/"+newSector,
            dataType: "json",
            success: function (data) {
                //alert(data);
               // console.log(data);
    ...
    function cl_to_pnc_fabrica(){
        ...
        if(sizeofTBL.length>0){
            ...
            type='success';
            title='Tem a certeza que pretende continuar?';
            text2='A palete será enviada para - ESPERA SAIDA PARA MOV P/ PNC FABRICA';
            action='confirmCLPNC';
            xposition='center';
    ...
    function confirm_cl_to_pnc_fabrica(){
    ...
    function save_motivo_pnc(){
        type='success';
        title='Tem a certeza que pretende continuar?';
        text2='Confirma a realização do movimento para PNC?';
        action='doublecheck';
        xposition='center';
        fire_annotation(type,title,text2,action,xposition,campo,valor);
    }
    ...
    function save_movement_to_pnc(){
        ...
        $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>stocks/NaoConforme/save_movement_to_pnc",
                dataType: "json",
                data:{
                    sector: newSector,
                    table: tableSelPaletes.getData(),
                    motivo: pnc,
                    codigomotivo: $("#pnc").val(),
