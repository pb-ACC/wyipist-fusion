            ...
            <div class="card card-info">
                ...
                <div class="card-footer" style="display: block;">
                    <div class="row">
                        ...
                        <div id="factory" class="col-sm-12 col-sm-push-3 col-xs-12 col-md-4 col-md-push-4 col-lg-4 col-lg-push-4" style="display:none;">
                        ...
                        <div id="move_logistics" class="col-sm-12 col-sm-push-3 col-xs-12 col-md-4 col-md-push-4 col-lg-4 col-lg-push-4" style="display:none;">
                            <button onclick="send_to_logistic()" type="button" class="btn btn-info" style="width:inherit;margin-left: 5px;margin-right: 5px;margin-bottom: 5px;"> Enviar Centro Logístico</button>
                        </div>
                        <div id="warehouse" class="col-sm-12 col-sm-push-3 col-xs-12 col-md-4 col-md-push-4 col-lg-4 col-lg-push-4" style="display:none;">
