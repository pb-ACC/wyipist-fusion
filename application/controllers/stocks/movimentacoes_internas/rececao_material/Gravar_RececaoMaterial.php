...
class Gravar_RececaoMaterial extends CI_Controller
{
        ...
        if($this->session->userdata('logged_in')) {
            ...
            if ($countTBL > 2) {
                ...
                for ($i = 0; $i < count($tbl); $i++) {
                    ...
                    $this->load->model('stocks/movimentacoes_internas/rececao_material/MovimentacoesInternas_rececao');
                    $this->MovimentacoesInternas_rececao->save_new_position($DocPL, $LinhaPL, $Referencia, $Artigo, $DescricaoArtigo, $Quantidade, $Unidade, $Sector, $Formato,
