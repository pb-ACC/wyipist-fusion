...
class Paletizar_Carga extends CI_Model
{
    ...
    public function movimento_stock_paletes($NumeroSP,$CodigoSP,$NumeroPL,$CodigoPL,$serie,$flag,$DocumentoCarga,$NumeroDocumento,$NumeroLinha,$QtdEN,$QtdPaletizada,$QtdFalta,
        ...
        $sql09="INSERT INTO ".$tbl01." (LinhaDocumento, NumeroDocumento, Documento, TipoMovimento, Sector, NumeroSerieInferior, NumeroSerieSuperior, Quantidade,
                                        ...
                                        TotalDescontosNM, DescFinNM, TotalIliquidoNM, TotalIvaNM, TotalLiquidoNM, OperadorMOV, DataHoraMOV, PaleteCliente)".
                "SELECT 0, '{$NumeroSP}', '', '12', '{$Sector}', 'PALETIZAÇÃO CLIENTE 2', '', {$NovaQtd}, {$NovaQtd}, '{$Referencia}', '{$Artigo}', '{$DescricaoArtigo}', '{$Formato}', 
                       ...
                       B.PrecoNM*{$NovaQtd}, 0, B.PrecoNM*{$NovaQtd}, B.PrecoNM*{$NovaQtd}, 0, 0, B.PrecoNM*{$NovaQtd}, 0, B.PrecoNM*{$NovaQtd},'{$user}', getdate(), '{$NumeroPL}'
                FROM PlLDocs B
            ...
            $sql13="INSERT INTO StkLDocs (LinhaDocumento, CodigoDocumento, NumeroDocumento, Documento, TipoMovimento, Sector, NumeroSerieInferior, NumeroSerieSuperior, Quantidade,
                                          QuantidadeUnidade, Referencia, Artigo, DescricaoArtigo, Formato, RefCor, Qual, TipoEmbalagem, Superficie, Lote, Calibre, Decoracao, 
                                          Acabamento, Coleccao, TabEspessura, RefP, Unidade, Preco, PrecoNM, Desconto, Iva, TaxaIva, Local, KeyScript, Palete, DocPL, LinhaPL, 
                                          TotalMercadoria, TotalDescontos, DescFin, TotalIliquido, TotalIva, TotalLiquido, TotalMercadoriaNM, TotalDescontosNM, DescFinNM, 
                                          TotalIliquidoNM, TotalIvaNM, TotalLiquidoNM, OperadorMOV, DataHoraMOV, UnidadeStock, RelUni, FactorRelUni, DataStockMOV, Status, Changed,
                                          QuantidadeUnStock, PaleteCliente, DocGG)".
                   "SELECT LinhaDocumento, 'SP', NumeroDocumento, Documento, TipoMovimento, Sector, NumeroSerieInferior, NumeroSerieSuperior, Quantidade, QuantidadeUnidade, Referencia, 
                           ...
                           DataHoraMOV, 'SP', 1, Quantidade, PaleteCliente, '{$DocumentoCarga}'
                    FROM ".$tbl01."";
                    //echo $sql09;
            $this->db->query($sql13);
            $this->db->close();
