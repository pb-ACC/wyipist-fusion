...
class MovimentacoesInternas_rececao extends CI_Model
{
    ...
    public function save_new_position($DocPL, $LinhaPL, $Referencia, $Artigo, $DescricaoArtigo, $Quantidade, $Unidade, $Sector, $Formato, $Qual, $TipoEmbalagem, $Superficie, 
                                      $Decoracao, $RefCor, $Lote, $TabEspessura, $Calibre, $Local, $novo_sector, $Nivel, $novo_local, $username, $funcionario_gpac){
        ...
        $this->remove_palete_setor_atual($Codigo, $Numero, $table_name, $DocPL, $LinhaPL, $Referencia, $Artigo, $DescricaoArtigo, $Quantidade, $Unidade, $Sector, $Formato, $Qual, 
                                      $TipoEmbalagem, $Superficie, $Decoracao, $RefCor, $Lote, $TabEspessura, $Calibre, $Local, $Nivel, $user);
        ...
        $this->insere_palete_novosector($Codigo, $Numero, $table_name, $DocPL, $LinhaPL, $Referencia, $Artigo, $DescricaoArtigo, $Quantidade, $Unidade, $Formato, $Qual, 
                                        $TipoEmbalagem, $Superficie, $Decoracao, $RefCor, $Lote, $TabEspessura, $Calibre, $Sector, $novo_sector, $Local, $novo_local, $Nivel, $user);    
    ...
    public function remove_palete_setor_atual($Codigo, $Numero, $table_name, $DocPL, $LinhaPL, $Referencia, $Artigo, $DescricaoArtigo, $Quantidade, $Unidade, $Sector, $Formato, $Qual, 
                                           $TipoEmbalagem, $Superficie, $Decoracao, $RefCor, $Lote, $TabEspessura, $Calibre, $Local, $Nivel, $user){
