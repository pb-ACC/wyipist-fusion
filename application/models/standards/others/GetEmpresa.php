...
class GetEmpresa extends CI_Model
{
    ...
    public function getEmpresa($username,$funcionario_gpac){

        $sql = "SELECT case when Empresa='CERAGNI' then 1 when Empresa='CERTECA' then 2 else 3 end TipoEmpresa, Empresa 
